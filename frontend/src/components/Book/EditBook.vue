                    ...
                    <div class="card-body">
                        <form @submit="onSubmit">
                            ...
                            <div class="form-group row">                                    
                                ...
                                <div class="col-sm-6">
                                    <textarea placeholder="Descripcion" name="description" class="form-control" rows="3" v-model.trim="form.description"></textarea>
                                </div>
                            </div>
                            <div class="rows">
                                <div class="col text-left">
    ...
    methods: {
        onSubmit(evt){
            ...
            axios.put(path, this.form ).then((response) => {
                ...
                alert('libro actualizado axitosamente')
            })
            .catch((error) => {
                console.log(error)
            })
